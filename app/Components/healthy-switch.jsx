      ...
      <div className="mt-12 relative group">
        ...
        >
          {products.map((item, index) => (
            ...
            >
              <div className="relative bg-[#ECECEC] rounded-lg h-[340px] overflow-hidden">

                <span className="absolute top-3 left-3 bg-white text-[#D36327] text-xs px-3 py-1 rounded-full z-20 shadow-sm">
                  Mustard
                </span>

                <span className="absolute top-0 right-0 bg-[#16A34A] text-white text-[11px] font-bold px-4 py-2 rounded-bl-2xl z-20">
                  Sale 70% off
                </span>
                ...
                {/* 🔥 MORE BOTTOM RIGHT */}
                <button className="absolute bottom-1 right-1 z-30 bg-[#D36327] text-white text-xs px-5 py-2.5 rounded-full flex items-center gap-2 hover:bg-[#b94f1c] transition shadow-lg">
